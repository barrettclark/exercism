defmodule Beer do
  ...
  defp second_line(verse_number) when verse_number == 0 do
    "Go to the store and buy some more, #{next_verse_number(verse_number)} bottles of beer on the wall.\n"
  end
  ...
  defp next_verse_number(verse_number) when verse_number > 0, do: verse_number - 1
  defp next_verse_number(_), do: 99

  defp bottle_text(bottle_count) when bottle_count == 0, do: "No more bottles"
  defp bottle_text(bottle_count) when bottle_count == 1, do: "#{bottle_count} bottle"
  defp bottle_text(bottle_count), do: "#{bottle_count} bottles"

  defp take_text(bottle_count) when bottle_count == 1, do: "it"
