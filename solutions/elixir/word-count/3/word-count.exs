defmodule Words do
  ...
  # returns an array of the lowercased words (without punctuation)
  ...
  defp count_words(words) do Enum.reduce words, HashDict.new, count(&1, &2) end

  # helper function to increment a counter
  defp increment(current_value) do current_value + 1 end

  # helper function to update the HashDict of counts
  defp count(word, acc) do HashDict.update(acc, word, 1, increment(&1)) end
end